...
export function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollPosition = window.scrollY + window.innerHeight / 3; // Trigger when section is 1/3 visible
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            ...
            <div 
              className="relative"
              style={{
                filter: 'brightness(1.05) saturate(1.1) drop-shadow(0 0 8px hsl(158, 65%, 58%, 0.3)) drop-shadow(0 0 16px hsl(158, 65%, 58%, 0.2))',
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 4px 16px hsl(158, 65%, 45%, 0.3)',
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              style={{
                color: 'hsl(158, 65%, 45%)', /* Green text from teal palette */
          ...
          <div className="md:hidden flex items-center space-x-3">
            ...
            <button
              ...
              style={{ 
                color: 'hsl(210, 15%, 20%)',
                backgroundColor: isMenuOpen ? 'hsl(158, 65%, 45%, 0.1)' : 'transparent'
              }}
            >
        ...
        {isMenuOpen && (
          <div 
            ...
            style={{ 
              backgroundColor: 'hsl(0, 0%, 99%, 0.95)', /* Background */
