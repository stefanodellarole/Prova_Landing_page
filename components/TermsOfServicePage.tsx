...
import { ArrowLeft, Download, UserCheck, Computer, UserPlus, ShieldCheck, Copyright, Clock, AlertTriangle, RefreshCw, Scale, Mail } from 'lucide-react';
    ...
    const printContent = `
      ...
      <html lang="en">
        <head>
          ...
          <title>Terms of Service - Splinter.ch</title>
          <style>
        ...
        <body>
          <div class="header">
            <h1>📋 ${t('terms.title')} ${t('terms.titleHighlight')} - ${t('terms.subtitle')}</h1>
            <p><strong>${t('terms.lastUpdated')}</strong></p>
            <p style="margin-top: 16px; font-style: italic;">${t('terms.intro')}</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 py-16 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto w-full">
          <div className="text-center space-y-8">
            ...
            {/* Introduction */}
            <div 
              className="p-8 rounded-lg text-left max-w-5xl mx-auto border"
              style={{ 
      ...
      <section className="px-6 py-16 bg-white">
        <div id="terms-content" className="max-w-5xl mx-auto w-full space-y-12">
          {t('terms.sections').map((section: any, index: number) => {
          ...
          <div className="text-center pt-12 no-print">
            ...
            >
              ...
              <p className="text-sm font-body leading-relaxed mb-6 text-gray-700">
                We're here to help clarify any questions about our terms. Contact us anytime at <strong style={{ color: 'hsl(158, 65%, 45%)' }}>info@splinter.ch</strong>
              </p>
